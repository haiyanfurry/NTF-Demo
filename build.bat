...
nasm %NASMFLAGS% main.asm    -o main.o    || exit /b 1
nasm %NASMFLAGS% cpuhdr.asm  -o cpuhdr.o  || exit /b 1
nasm %NASMFLAGS% input.asm   -o input.o   || exit /b 1
nasm %NASMFLAGS% decode.asm  -o decode.o  || exit /b 1
nasm %NASMFLAGS% codegen.asm -o codegen.o || exit /b 1
